...
/// haptics loop.
Vec3d DHDHapticsDevice::getPosition() {
#ifdef HAVE_DHDAPI
  if( device_id != -1 ) {
    Vec3d r;
...
/// haptics loop.
Vec3d DHDHapticsDevice::getVelocity() {
  return Vec3d( 0, 0, 0 );
}
...
/// haptics loop.
void DHDHapticsDevice::sendForce( const Vec3d &f ) {
#ifdef HAVE_DHDAPI
  if( device_id != -1 ) {
...
/// haptics loop.
void DHDHapticsDevice::sendTorque( const Vec3d &f ) {
#ifdef HAVE_DHDAPI
  if( device_id != -1 ) {
