...
IF( WIN32 AND PREFER_STATIC_LIBRARIES )
  FIND_LIBRARY( FTGL_STATIC_LIBRARY NAMES ftgl_static_MTD
                                         PATHS $ENV{H3D_EXTERNAL_ROOT}/lib
                                         $ENV{H3D_ROOT}/../External/lib
                                         ../../External/lib
                                         ${CMAKE_MODULE_PATH}/../../../External/lib )
...
IF( FTGL_LIBRARY OR FTGL_STATIC_LIBRARY )
  SET( FTGL_LIBRARIES_FOUND 1 )
ENDIF( FTGL_LIBRARY OR FTGL_STATIC_LIBRARY )

# Copy the results to the output variables.
IF(FTGL_INCLUDE_DIR AND FTGL_LIBRARIES_FOUND)
  SET(FTGL_FOUND 1)
  
  IF( WIN32 AND PREFER_STATIC_LIBRARIES AND FTGL_STATIC_LIBRARY )
    SET(FTGL_LIBRARIES ${FTGL_STATIC_LIBRARY})
    SET( FTGL_LIBRARY_STATIC 1 )
  ELSE( WIN32 AND PREFER_STATIC_LIBRARIES AND FTGL_STATIC_LIBRARY )
    SET(FTGL_LIBRARIES ${FTGL_LIBRARY})
  ENDIF( WIN32 AND PREFER_STATIC_LIBRARIES AND FTGL_STATIC_LIBRARY )
