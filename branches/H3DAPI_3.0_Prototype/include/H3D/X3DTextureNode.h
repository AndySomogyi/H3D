...
namespace H3D {
  ...
  public:
	...
	/// bound in OpenGL. NULL is returned if no X3DTextureNode is bound. 
	...
	///
	virtual TextureHandle renderImage( Image *image, 
	...
	///
	/// The texture is written immediately and the success or failure of the save 
