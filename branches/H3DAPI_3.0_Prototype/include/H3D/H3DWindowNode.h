...
namespace H3D {
  ...
  public:
	...
	// Virtual function, though actually defined in source, 
	// to be able to handle navigation from outside the class as well,
	// because we don't always want to call H3DWindowNode::render
