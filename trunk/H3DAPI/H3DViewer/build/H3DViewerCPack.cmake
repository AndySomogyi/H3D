...
if( GENERATE_H3DVIEWER_CPACK_PROJECT )
  ...
  if( WIN32 )
    ...
    if( H3DUtil_INCLUDE_DIRS )
      set( includes_to_search ${H3DUtil_INCLUDE_DIRS} )
    endif()
    if( HAPI_INCLUDE_DIRS )
      set( includes_to_search ${includes_to_search} ${HAPI_INCLUDE_DIRS} )
    endif()
    if( H3DAPI_INCLUDE_DIRS )
      set( includes_to_search ${includes_to_search} ${H3DAPI_INCLUDE_DIRS} )
    endif()
